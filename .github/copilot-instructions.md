...
- Document generation uses Quarto when available and falls back to HTML/PDF conversion path in orchestrator methods; do not assume Quarto is always installed.
